...
hmmer_meta_features_text = """Trimmed alignment: By default, we trim insertions with respect to the query (human) out of alignments.
To see full alignment with gaps and surrounding amino acid context, toggle off trimmed alignment.
    ...
    match_to_homologue=HMMER match has an annotated orthologue relationship with human gene.\n
